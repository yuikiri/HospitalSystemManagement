 ...
 * @author Yuikiri
 */
public class LoadDoctorShiftController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (doctor != null) {
            ...
            List<DoctorShiftDTO> shiftList = dao.getShiftsByDoctorId(doctor.getId());
            
            request.setAttribute("shiftList", shiftList);
            
            // In ra console để sếp kiểm tra data lấy được chưa
            System.out.println("========== LỊCH TRỰC BÁC SĨ ==========");
