...
<div class="nav flex-column mt-4 px-2">
    ...
    <a id="menu-appointment" class="nav-item-custom" onclick="loadContent('${pageContext.request.contextPath}/MainController?action=LoadGetAppointment', this)">
        <i class="bi bi-clipboard-pulse nav-icon"></i> Tiếp nhận Lịch hẹn
    </a>
    
    <a id="menu-shift" class="nav-item-custom" onclick="loadContent('${pageContext.request.contextPath}/MainController?action=LoadDoctorShift', this)">
        <i class="bi bi-calendar-week nav-icon"></i> Lịch Ca Trực
    </a>
